<div class="systemEmailAttachments index">
<?php 
	echo "<h2>".__('System Email Attachments')."</h2>";
...
<?php
	$pageHeader="<thead>";
		$pageHeader.="<tr>";
			...
			$pageHeader.="<th>".$this->Paginator->sort('url_attachment')."</th>";
	...
	$excelHeader="<thead>";
		$excelHeader.="<tr>";
			...
			$excelHeader.="<th>".$this->Paginator->sort('url_attachment')."</th>";
		$excelHeader.="</tr>";
	$excelHeader.="</thead>";
	...
	foreach ($systemEmailAttachments as $systemEmailAttachment){ 
		$pageRow=""		$pageRow=""		$pageRow.="<td>".$this->Html->link($systemEmailAttachment['SystemEmail']['id'], array('controller' => 'system_emails', 'action' => 'view', $systemEmailAttachment['SystemEmail']['id']))."</td>";
		$pageRow=""		$pageRow.="<td>".h($systemEmailAttachment['SystemEmailAttachment']['url_attachment'])."</td>";
		$pageRow=""		$pageRow=""
			$excelBody.="<tr>".$pageRow."</tr>";

			$pageRow.="<td class='actions'>";
				$pageRow.=$this->Html->link(__('View'), array('action' => 'view', $systemEmailAttachment['SystemEmailAttachment']['id']));
				$pageRow.=$this->Html->link(__('Edit'), array('action' => 'edit', $systemEmailAttachment['SystemEmailAttachment']['id']));
				//$pageRow.=->postLink(__('Delete'), array('action' => 'delete', $systemEmailAttachment['SystemEmailAttachment']['id']), array(), __('Are you sure you want to delete # %s?', $systemEmailAttachment['SystemEmailAttachment']['id']));
			$pageRow.="</td>";
