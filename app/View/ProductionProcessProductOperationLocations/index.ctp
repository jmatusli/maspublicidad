<div class="productionProcessProductOperationLocations index">
<?php 
	echo "<h2>".__('Production Process Product Operation Locations')."</h2>";
...
<?php
	$pageHeader="<thead>";
		$pageHeader.="<tr>";
			$pageHeader.="<th>".$this->Paginator->sort('production_process_product_id')."</th>";
			$pageHeader.="<th>".$this->Paginator->sort('operation_location_id')."</th>";
			$pageHeader.="<th class='actions'>".__('Actions')."</th>";
		$pageHeader.="</tr>";
	$pageHeader.="</thead>";
	$excelHeader="<thead>";
		$excelHeader.="<tr>";
			$excelHeader.="<th>".$this->Paginator->sort('production_process_product_id')."</th>";
			$excelHeader.="<th>".$this->Paginator->sort('operation_location_id')."</th>";
		$excelHeader.="</tr>";
	$excelHeader.="</thead>";
	...
	foreach ($productionProcessProductOperationLocations as $productionProcessProductOperationLocation){ 
		$pageRow=""		$pageRow=""		$pageRow.="<td>".$this->Html->link($productionProcessProductOperationLocation['ProductionProcessProduct']['id'], array('controller' => 'production_process_products', 'action' => 'view', $productionProcessProductOperationLocation['ProductionProcessProduct']['id']))."</td>";
		$pageRow=""		$pageRow.="<td>".$this->Html->link($productionProcessProductOperationLocation['OperationLocation']['name'], array('controller' => 'operation_locations', 'action' => 'view', $productionProcessProductOperationLocation['OperationLocation']['id']))."</td>";
		$pageRow=""		$pageRow=""
			$excelBody.="<tr>".$pageRow."</tr>";

			$pageRow.="<td class='actions'>";
				$pageRow.=$this->Html->link(__('View'), array('action' => 'view', $productionProcessProductOperationLocation['ProductionProcessProductOperationLocation']['id']));
				$pageRow.=$this->Html->link(__('Edit'), array('action' => 'edit', $productionProcessProductOperationLocation['ProductionProcessProductOperationLocation']['id']));
				//$pageRow.=->postLink(__('Delete'), array('action' => 'delete', $productionProcessProductOperationLocation['ProductionProcessProductOperationLocation']['id']), array(), __('Are you sure you want to delete # %s?', $productionProcessProductOperationLocation['ProductionProcessProductOperationLocation']['id']));
			$pageRow.="</td>";
