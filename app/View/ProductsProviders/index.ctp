<div class="productsProviders index">
<?php 
	echo "<h2>".__('Products Providers')."</h2>";
...
<?php
	...
	foreach ($productsProviders as $productsProvider){ 
		$pageRow="";
			$pageRow.="<td>".$this->Html->link($productsProvider['Product']['name'], array('controller' => 'products', 'action' => 'view', $productsProvider['Product']['id']))."</td>";
			$pageRow.="<td>".$this->Html->link($productsProvider['Provider']['name'], array('controller' => 'providers', 'action' => 'view', $productsProvider['Provider']['id']))."</td>";
			$pageRow.="<td>".h($productsProvider['ProductsProvider']['application_date'])."</td>";
			$pageRow.="<td>".h($productsProvider['ProductsProvider']['bool_active'])."</td>";

			$excelBody.="<tr>".$pageRow."</tr>";

			$pageRow.="<td class='actions'>";
				$pageRow.=$this->Html->link(__('View'), array('action' => 'view', $productsProvider['ProductsProvider']['id']));
				$pageRow.=$this->Html->link(__('Edit'), array('action' => 'edit', $productsProvider['ProductsProvider']['id']));
				//$pageRow.=->postLink(__('Delete'), array('action' => 'delete', $productsProvider['ProductsProvider']['id']), array(), __('Are you sure you want to delete # %s?', $productsProvider['ProductsProvider']['id']));
			$pageRow.="</td>";
