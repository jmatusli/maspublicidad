<div class="invoiceProducts index">
<?php 
	echo "<h2>".__('Invoice Products')."</h2>";
...
<?php
	...
	foreach ($invoiceProducts as $invoiceProduct){ 
		$pageRow="";
			$pageRow.="<td>".$this->Html->link($invoiceProduct['Invoice']['id'], array('controller' => 'invoices', 'action' => 'view', $invoiceProduct['Invoice']['id']))."</td>";
			$pageRow.="<td>".$this->Html->link($invoiceProduct['Product']['name'], array('controller' => 'products', 'action' => 'view', $invoiceProduct['Product']['id']))."</td>";
			$pageRow.="<td>".h($invoiceProduct['InvoiceProduct']['product_unit_price'])."</td>";
			$pageRow.="<td>".h($invoiceProduct['InvoiceProduct']['product_quantity'])."</td>";
			$pageRow.="<td>".h($invoiceProduct['InvoiceProduct']['product_total_price'])."</td>";
			$pageRow.="<td>".$this->Html->link($invoiceProduct['Currency']['abbreviation'], array('controller' => 'currencies', 'action' => 'view', $invoiceProduct['Currency']['id']))."</td>";

			$excelBody.="<tr>".$pageRow."</tr>";

			$pageRow.="<td class='actions'>";
				$pageRow.=$this->Html->link(__('View'), array('action' => 'view', $invoiceProduct['InvoiceProduct']['id']));
				$pageRow.=$this->Html->link(__('Edit'), array('action' => 'edit', $invoiceProduct['InvoiceProduct']['id']));
				//$pageRow.=->postLink(__('Delete'), array('action' => 'delete', $invoiceProduct['InvoiceProduct']['id']), array(), __('Are you sure you want to delete # %s?', $invoiceProduct['InvoiceProduct']['id']));
			$pageRow.="</td>";
