		...
		echo "<table id='productos'>";
			echo "<thead>";
				echo "<tr>";
					...
					echo "<th>".__('IVA?')."</th>";
					echo "<th class='hidden'>".__('Product Department Id')."</th>";
			...
			foreach ($productsForQuotation as $product){
				...
				echo "<tr row='".$i."'>";
					...
					echo "<td class='productdescription'>".$this->Form->input('SalesOrderProduct.'.$i.'.product_description',array('label'=>false,'default'=>$product['QuotationProduct']['product_description']))."</td>";
					...
					echo "<td class='productdepartmentid hidden'>".$product['Product']['Department']['id']."</td>";
					echo "<td class='departmentid'>".$this->Form->input('SalesOrderProduct.'.$i.'.department_id',array('label'=>false,'default'=>$product['Product']['Department']['id'],'multiple'=>'multiple','empty'=>array('0'=>'Seleccione Departamento')))."</td>";
