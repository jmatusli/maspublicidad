	...
	foreach ($holidayTypes as $holidayType){ 
			...
			$pageRow.="<td class='actions'>";
				...
				if ($bool_delete_permission){
					//$pageRow.=$this->Form->postLink(__('Delete'), array('action' => 'delete', $holidayType['HolidayType']['id']), array(), __('Are you sure you want to delete # %s?', $holidayType['HolidayType']['id']));
				}
			$pageRow.="</td>";
