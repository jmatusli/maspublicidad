...
<?php echo $this->Form->create('SalesOrderProductDepartment'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sales Order Product Department'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SalesOrderProductDepartment.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('SalesOrderProductDepartment.id'))); ?></li>
