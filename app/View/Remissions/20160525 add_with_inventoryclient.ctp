...
<?php 
	...
	echo "<fieldset>";
		echo "<legend>".__('Add Remission')."</legend>";
	echo "<div class='container-fluid'>";
			echo "<div class='rows'>";
				echo "<div class='col-md-9'>";
					...
					echo $this->Form->input('inventory_client_id');
				...
				echo "<div class='col-md-3'>";					
					echo $this->Form->input('price_subtotal',array('readonly'=>'readonly','type'=>'decimal','default'=>'0', 'between' => '<span class=\'currency totalbox\'></span>'));
					echo $this->Form->input('price_iva',array('readonly'=>'readonly','type'=>'decimal','default'=>'0', 'between' => '<span class=\'currency totalbox\'></span>'));
					echo $this->Form->input('price_total',array('readonly'=>'readonly','type'=>'decimal','default'=>'0', 'between' => '<span class=\'currency totalbox\'></span>'));
				echo "</div>";
