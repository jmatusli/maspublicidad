...
<?php 
	...
	echo $this->Form->create('Report');
		echo "<fieldset>";
			...
			echo $this->Form->input('Report.product_id',array('label'=>__('Product'),'dateFormat'=>'DMY','default'=>$product_id,'empty'=>array('0'=>'Todos')));
...
<?php 
	...
	echo "<ul>";
		...
		echo "<br/>";
		echo "<li>".$this->Html->link(__('List Providers'), array('controller' => 'providers', 'action' => 'resumenProveedoresInventario'))."</li>";
...
<?php
	...
	foreach ($entries as $entry){ 
		...
		$pageRow.="<td>".$this->Html->link($entry['Provider']['name'], array('controller' => 'providers', 'action' => 'view', $entry['Provider']['id']))."</td>";
