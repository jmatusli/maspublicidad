...
<?php echo $this->Form->create('ProductionOrderProductDepartment'); ?>
	<fieldset>
		<legend><?php echo __('Edit Production Order Product Department'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ProductionOrderProductDepartment.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('ProductionOrderProductDepartment.id'))); ?></li>
