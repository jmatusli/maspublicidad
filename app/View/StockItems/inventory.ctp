...
<?php
	...
	foreach ($stockItems as $stockItem){ 
		$pageRow="";
		$pageRow.="<td>".h($stockItem['StockItem']['name'])."</td>";
		$pageRow.="<td>".h($stockItem['StockItem']['description'])."</td>";
		$pageRow.="<td>".$this->Html->link($stockItem['Product']['name'], array('controller' => 'products', 'action' => 'view', $stockItem['Product']['id']))."</td>";
		$pageRow.="<td>".h($stockItem['StockItem']['product_unit_cost'])."</td>";
		$pageRow.="<td>".$this->Html->link($stockItem['Currency']['abbreviation'], array('controller' => 'currencies', 'action' => 'view', $stockItem['Currency']['id']))."</td>";
		$pageRow.="<td>".h($stockItem['StockItem']['product_original_quantity'])."</td>";
		$pageRow.="<td>".h($stockItem['StockItem']['product_remaining_quantity'])."</td>";
		$pageRow.="<td>".$this->Html->link($stockItem['MeasuringUnit']['name'], array('controller' => 'measuring_units', 'action' => 'view', $stockItem['MeasuringUnit']['id']))."</td>";
		$pageRow.="<td>".h($stockItem['StockItem']['stock_item_creation_date'])."</td>";
