        ...
        $output.='<div id="invoicePrint" style="width:202mm;height:270mm;padding:0mm;">';  
          ...
          $output.='<div class="top_banner">';
            ...
            $output.='<div class="top_banner_data">';
              $output.='<div class="invoice_code">'.$invoice['Invoice']['invoice_code'].'</div>';
          ...
          $output.='<div class="client_details">';
            $output.='<table style="font-size:15pt;">';
              ...
              $output.='<tr>';
                ...
                $output.='<td class="left">'.$invoice['Invoice']['reference'].'</td>';
              $output.='</tr>';
          ...
          $output.='<div class="invoice_date">';
            $output.='<table style="font-size:15pt;width:100%;">';
              $output.='<thead style="min-height:14mm;height:14mm;">';
                $output.='<tr>';
                  $output.='<th class="centered noprint">DIA</th>';
                  $output.='<th class="centered noprint">MES</th>';
                  $output.='<th class="centered noprint">AÑO</th>';
                $output.='</tr>';
              $output.='</thead>'; 
              $output.='<tbody>';
                $output.='<tr>';            
          ...
          $output.='<div class="invoice_products">';
            $output.='<table>';
              $output.='<thead style="height:14mm;font-size:15pt;">';
                $output.='<tr>';
                  $output.='<th class="centered noprint" style="width:35mm;">Cantidad</th>';
                  $output.='<th class="noprint" style="width:102mm;">Descripción</th>';
                  $output.='<th class="centered noprint" style="width:32mm;">P. Unitario</th>';
                  $output.='<th class="centered noprint" style="width:27mm;">Total</th>';
                $output.='</tr>';
              $output.='</thead>';
          ...
          $output.='<div class="invoice_conditions">';
            ...
            $output.='<div style="font-size:9.2pt">';
              ...
              $output.='<span class="left bold" style="font-size:12pt; width:15mm;">'.number_format($invoice['Invoice']['price_total_cs'],2,".",",").'</span>';
              $output.='<span class="left noprint" style="text-align:justify;"> o US$ </span>';
              $output.='<span class="left bold" style="font-size:12pt;width:15mm;">'.number_format($invoice['Invoice']['price_total_usd'],2,".",",").'</span>';
          ...
          $output.='<div class="invoice_totals">';
            ...
            $output.='<div style="width:33mm;height:35mm;float:left;font-size:15pt;line-height:15pt;font-weight:700;">  
