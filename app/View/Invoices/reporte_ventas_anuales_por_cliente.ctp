...
<?php	
	echo "<h2>".__('Reporte de Ventas Anuales por Cliente')."</h2>";
      ...
      echo "<div class='container-fluid'>";
        echo "<div class='row'>";
          ...
          echo "<div class='col-md-6'>";     
            ...
            echo $this->Form->input('Report.cutoff_amount',['label'=>__('Monto total vendido'),'default'=>$cutoffAmount,'type'=>'hidden']);
            echo $this->Form->input('Report.frequency_number',['label'=>__('Frecuencia (meses por año)'),'default'=>$frequencyNumber,'type'=>'hidden']);
            ...
            echo $this->Form->input('Report.bool_or_condition_id',['label'=>__('Procesar condiciones'),'default'=>$boolOrConditionId,'type'=>'hidden']);
          echo "</div>";
          echo "<div class='col-md-3'>";     
            echo $allClientTable;
          echo "</div>";
  ...
  echo $this->Form->Submit(__('Refresh'));  
	...
	echo $this->Html->link(__('Guardar como Excel'), ['action' => 'guardarReporteVentasAnualesPorCliente'], ['class' => 'btn btn-primary']); 
  ...
  echo $normalClientTable;
	...
	$_SESSION['reporteVentasAnualesPorCliente'] = $vipClientTable.$objectiveClientTable.$normalClientTable;
?>
</div>
<script>
