...
<?php echo $this->Form->create('PurchaseOrderOtherCost'); ?>
	<fieldset>
		<legend><?php echo __('Edit Purchase Order Other Cost'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PurchaseOrderOtherCost.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('PurchaseOrderOtherCost.id'))); ?></li>
