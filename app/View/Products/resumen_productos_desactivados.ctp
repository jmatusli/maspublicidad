...
<?php 
	echo "<h2>Productos Desactivados</h2>";
	...
	echo $this->Html->link(__('Guardar como Excel'), array('action' => 'guardarResumen','Resumen Productos Desactivados'), array( 'class' => 'btn btn-primary'));
?> 
</div>
<div class='actions'>
<?php 
	...
	echo "<ul>";
		...
		echo "<br/>";
    echo "<li>". $this->Html->link(__('Productos Activos'), array('action' => 'index'))."</li>";
		echo "<br/>";
...
<?php
	...
	*/
	...
	$table_id="productos_desactivados";
