<div class="measuringUnits index">
<?php 
	echo "<h2>".__('Measuring Units')."</h2>";
...
<?php
	...
	foreach ($measuringUnits as $measuringUnit){ 
		$pageRow=""		$pageRow=""		$pageRow.="<td>".h($measuringUnit['MeasuringUnit']['abbreviation'])."</td>";
		$pageRow=""		$pageRow.="<td>".h($measuringUnit['MeasuringUnit']['name'])."</td>";

			$excelBody.="<tr>".$pageRow."</tr>";

			$pageRow.="<td class='actions'>";
				$pageRow.=$this->Html->link(__('View'), array('action' => 'view', $measuringUnit['MeasuringUnit']['id']));
				$pageRow.=$this->Html->link(__('Edit'), array('action' => 'edit', $measuringUnit['MeasuringUnit']['id']));
				//$pageRow.=->postLink(__('Delete'), array('action' => 'delete', $measuringUnit['MeasuringUnit']['id']), array(), __('Are you sure you want to delete # %s?', $measuringUnit['MeasuringUnit']['id']));
			$pageRow.="</td>";
