...
<?php echo $this->Form->create('MeasuringUnit'); ?>
	<fieldset>
		<legend><?php echo __('Edit Measuring Unit'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MeasuringUnit.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('MeasuringUnit.id'))); ?></li>
