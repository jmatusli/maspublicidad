		...
		if (salesorderproductid>0){
			$.ajax({
				...
				success: function (salesorderproductinfo) {
					currentrow.find('td.salesorderproductid input.product_id').val(salesorderproductinfo['Product']['id']);
			...
			currentrow.find('td.salesorderproductid input.product_id').val(0);
...
<?php 
	...
	echo "<fieldset>";
		echo "<legend>".__('Add Production Process')."</legend>";
		echo "<div class='container-fluid'>";
			echo "<div class='row'>";
				echo "<div class='col-md-6'>";
					echo $this->Form->input('production_process_date',array('dateFormat'=>'DMY'));
					echo $this->Form->input('department_id',array('default'=>$department_id,'empty'=>array('0'=>'Seleccione Departamento')));
					...
					echo "<table id='productos'>";
						...
						for ($i=0;$i<count($requestProducts);$i++){
							echo "<tr row='".$i."'>";
								...
								echo "</td>";
								echo "<td class='pendingquantity amount'>".$this->Form->input('ProductionProcessProduct.'.$i.'.pending_quantity',array('label'=>false,'value'=>$requestProducts[$i]['ProductionProcessProduct']['pending_quantity'],'type'=>'decimal','readonly'=>'readonly'))."</td>";
