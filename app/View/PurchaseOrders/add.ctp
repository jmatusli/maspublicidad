...
<?php 
	...
	echo "<fieldset>";
		echo "<legend>".__('Crear Orden de Compra Adicional')."</legend>";
		...
		echo "<div class='container-fluid'>";
			echo "<div class='row'>";
				echo "<div class='col-md-6'>";
					...
					echo $this->Form->input('planned_delivery_date',array('dateFormat'=>'DMY'));
					...
					echo "<table id='purchaseOrderProducts'>";
						...
						for ($pop=$counter;$pop<30;$pop++){
							if ($pop==$counter){
								...
								echo "<td class='productid'>";
									echo $this->Form->input('PurchaseOrderProduct.'.$pop.'.product_id',array('label'=>false,'default'=>0,'empty'=>array('0'=>'Seleccione Producto')));
									echo $this->Form->input('PurchaseOrderProduct.'.$pop.'.sales_order_product_id',array('label'=>false,'default'=>0,'type'=>'hidden'));
								echo "</td>";
								// 20160723 Crear Orden de Compra solamente se debe utilizar para ordenes de compra que tienen productos que no eran en la orden de producción aun
								//echo "<td class='hidden'>".$this->Form->input('PurchaseOrderProduct.'.$pop.'.production_order_product_id',array('label'=>false,'value'=>0,'type'=>'hidden'))."</td>";
