...
<?php
	$pageHeader="<thead>";
		$pageHeader.="<tr>";
			...
			$pageHeader.="<th>".$this->Paginator->sort('stock_item_date')."</th>";
			...
			$pageHeader.="<th>".$this->Paginator->sort('stock_movement_id')."</th>";
	...
	$excelHeader="<thead>";
		$excelHeader.="<tr>";
			...
			$excelHeader.="<th>".$this->Paginator->sort('stock_item_date')."</th>";
			...
			$excelHeader.="<th>".$this->Paginator->sort('stock_movement_id')."</th>";
		$excelHeader.="</tr>";
	$excelHeader.="</thead>";
	...
	foreach ($stockItemLogs as $stockItemLog){ 
		$pageRow=""		$pageRow=""		$pageRow.="<td>".$this->Html->link($stockItemLog['StockItem']['name'], array('controller' => 'stock_items', 'action' => 'view', $stockItemLog['StockItem']['id']))."</td>";
		$pageRow=""		$pageRow.="<td>".h($stockItemLog['StockItemLog']['stock_item_date'])."</td>";
		$pageRow=""		$pageRow.="<td>".$this->Html->link($stockItemLog['Product']['name'], array('controller' => 'products', 'action' => 'view', $stockItemLog['Product']['id']))."</td>";
		$pageRow=""		$pageRow.="<td>".h($stockItemLog['StockItemLog']['product_quantity'])."</td>";
		$pageRow=""		$pageRow.="<td>".$this->Html->link($stockItemLog['MeasuringUnit']['name'], array('controller' => 'measuring_units', 'action' => 'view', $stockItemLog['MeasuringUnit']['id']))."</td>";
		$pageRow=""		$pageRow.="<td>".h($stockItemLog['StockItemLog']['product_unit_cost'])."</td>";
		$pageRow=""		$pageRow.="<td>".$this->Html->link($stockItemLog['Currency']['abbreviation'], array('controller' => 'currencies', 'action' => 'view', $stockItemLog['Currency']['id']))."</td>";
		$pageRow=""		$pageRow.="<td>".$this->Html->link($stockItemLog['StockMovement']['id'], array('controller' => 'stock_movements', 'action' => 'view', $stockItemLog['StockMovement']['id']))."</td>";
		$pageRow=""		$pageRow=""
			$excelBody.="<tr>".$pageRow."</tr>";

			$pageRow.="<td class='actions'>";
				$pageRow.=$this->Html->link(__('View'), array('action' => 'view', $stockItemLog['StockItemLog']['id']));
				$pageRow.=$this->Html->link(__('Edit'), array('action' => 'edit', $stockItemLog['StockItemLog']['id']));
				//$pageRow.=->postLink(__('Delete'), array('action' => 'delete', $stockItemLog['StockItemLog']['id']), array(), __('Are you sure you want to delete # %s?', $stockItemLog['StockItemLog']['id']));
			$pageRow.="</td>";
