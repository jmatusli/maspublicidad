<div class="productionOrderProducts index">
<?php 
	echo "<h2>".__('Production Order Products')."</h2>";
...
<?php
	...
	foreach ($productionOrderProducts as $productionOrderProduct){ 
		$pageRow=""		$pageRow=""		$pageRow.="<td>".$this->Html->link($productionOrderProduct['ProductionOrder']['id'], array('controller' => 'production_orders', 'action' => 'view', $productionOrderProduct['ProductionOrder']['id']))."</td>";
		$pageRow=""		$pageRow.="<td>".$this->Html->link($productionOrderProduct['Product']['name'], array('controller' => 'products', 'action' => 'view', $productionOrderProduct['Product']['id']))."</td>";
		$pageRow=""		$pageRow.="<td>".h($productionOrderProduct['ProductionOrderProduct']['product_quantity'])."</td>";
		$pageRow=""		$pageRow=""
			$excelBody.="<tr>".$pageRow."</tr>";

			$pageRow.="<td class='actions'>";
				$pageRow.=$this->Html->link(__('View'), array('action' => 'view', $productionOrderProduct['ProductionOrderProduct']['id']));
				$pageRow.=$this->Html->link(__('Edit'), array('action' => 'edit', $productionOrderProduct['ProductionOrderProduct']['id']));
				//$pageRow.=->postLink(__('Delete'), array('action' => 'delete', $productionOrderProduct['ProductionOrderProduct']['id']), array(), __('Are you sure you want to delete # %s?', $productionOrderProduct['ProductionOrderProduct']['id']));
			$pageRow.="</td>";
