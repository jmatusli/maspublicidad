...
<?php 
	echo $this->Form->create('Client'); 
		echo "<fieldset>";
            ...
            echo $this->Form->input('bool_generic',['label'=>'Cliente genérico']);
            ...
            echo $this->Form->input('creating_user_id',array('type'=>'hidden'));
				...
				echo "<div class='col-sm-3'>";
					//pr($users);
					//echo "<div id='VendorList' style='width:45%;float:left;clear:none;' class='col-sm-6'>";
	...
	echo "<table id='contactosParaCliente'>"; 
		...
		for ($i = count($existingContacts);$i < MAX_CONTACTS;$i++) { 
