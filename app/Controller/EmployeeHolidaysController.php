...
class EmployeeHolidaysController extends AppController {
	...
	public function index() {
		...
		$this->Paginator->settings = array(
			...
			'order'=>'EmployeeHoliday.holiday_date DESC',
		...
		$bool_employee_index_permission=$this->hasPermission($this->Session->read('User.id'),$aco_name);
		$this->set(compact('bool_employee_index_permission'));
		$aco_name="Employees/add";		
		$bool_employee_add_permission=$this->hasPermission($this->Session->read('User.id'),$aco_name);
 ...
 */
	public function delete($id = null) {
		...
		$employeeHoliday=$this->EmployeeHoliday->find('first',array(
			'conditions'=>array(
		...
		if ($this->EmployeeHoliday->delete()) {
			...
			$deletionArray['Deletion']['reference_id']=$employeeHoliday['EmployeeHoliday']['id'];
			$deletionArray['Deletion']['reference']=$employeeHoliday['Employee']['first_name']." ".$employeeHoliday['Employee']['last_name'];
			$deletionArray['Deletion']['type']='EmployeeHoliday';
