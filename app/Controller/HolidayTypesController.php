 ...
 */
	public function delete($id = null) {
		...
		$holidayType=$this->HolidayType->find('first',array(
			'conditions'=>array(
				'HolidayType.id'=>$id,
			),
		));
		...
		if ($this->HolidayType->delete()) {
			...
			$deletionArray['Deletion']['reference_id']=$holidayType['HolidayType']['id'];
			$deletionArray['Deletion']['reference']=$holidayType['HolidayType']['name'];
			$deletionArray['Deletion']['type']='HolidayType';
