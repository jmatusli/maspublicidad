...
class ExchangeRatesController extends AppController {
	...
	public function beforeFilter() {
		...
		$this->Auth->allow('getexchangerate');		
	}
 ...
 */
	public function delete($id = null) {
		...
		$exchangeRate=$this->ExchangeRate->find('first',array(
			'conditions'=>array(
				'ExchangeRate.id'=>$id,
			),
		));
		...
		if ($this->ExchangeRate->delete()) {
			...
			$deletionArray['Deletion']['reference_id']=$exchangeRate['ExchangeRate']['id'];
			$deletionArray['Deletion']['reference']=$exchangeRate['ExchangeRate']['rate'];
			$deletionArray['Deletion']['type']='ExchangeRate';
