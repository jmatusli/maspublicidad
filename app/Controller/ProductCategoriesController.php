 ...
 */
	public function delete($id = null) {
		...
		$productCategory=$this->ProductCategory->find('first',array(
			'conditions'=>array(
		...
		if ($this->ProductCategory->delete()) {
			...
			$deletionArray['Deletion']['reference_id']=$productCategory['ProductCategory']['id'];
			$deletionArray['Deletion']['reference']=$productCategory['ProductCategory']['name'];
			$deletionArray['Deletion']['type']='ProductCategory';
